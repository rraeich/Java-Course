...
public class Forest extends BattleLocations {
    ...
    public void enterBattleLocation() {
        ...
        if (notReady == 0) {
            ...
            System.out.println("Dont forget, You must defeat all the vampires to win the special reward (Firewood).");
            System.out.println("Also, you have chance to will guns,armors or potions.");
            System.out.println("You will fight a random number of enemies(3-5).");
            ...
            int enemyCount = random.nextInt(3, 6);
            ...
            if (getPlayer().getInventory().isWood()) {
                ...
                System.out.println("The Wood has been added to your inventory.");
                System.out.println("|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|");
                System.out.println();
            } else {
                System.out.println("You lost. You have to enter the forest again.");
