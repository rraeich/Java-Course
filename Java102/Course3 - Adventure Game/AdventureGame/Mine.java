...
public class Mine extends BattleLocations {
    ...
    public Mine(Player player, Snake snake) {
        super(player, snake);
    }
    ...
    public void enterBattleLocation() {
        ...
        if (notReady == 0) {
            ...
            System.out.println("Entering the mine is optional.");
            System.out.println("Mine is only for looting so, has a higher chance of dropping treasure.");
            System.out.println("Also, snake's critic attack chance is %10.");
            System.out.println("You will fight a random number of enemies(5-8).");
            ...
            getMonster().monsterInfoSnake();

            int enemyCount = random.nextInt(5, 9);
            ...
            if (isStartFirst) {
                ...
                while (monsterCounter <= enemyCount && getPlayer().getHealth() > 0) {
                    ...
                    while (getPlayer().getHealth() > 0 && getMonster().getHealth() > 0) {
                        randomEnemyDamage = random.nextInt(0, 3);
                        tourCounter++;
                        ...
                        if (getMonster().getHealth() <= 0) {
                            beatEnemyMine(monsterCounter);

                            monsterCounter++;

                            if (monsterCounter > enemyCount && getPlayer().getHealth() > 0) {
                                getPlayer().getInventory().setMineEnter(true);
                        ...
                        criticAttackChanceEnemy = random.nextInt(10, 21);
                        if (criticAttackChanceEnemy == 17) {
                            System.out.println(getMonster().getName() + " --->>" + ((getMonster().getDamage() + randomEnemyDamage) * 2) + "  " + getPlayer().getName());
                            ...
                            getPlayer().setHealth(getPlayer().getHealth() - ((getMonster().getDamage() + randomEnemyDamage) * 2));
                            System.out.println(getPlayer().getHealth());
                        } else {
                            System.out.println(getMonster().getName() + " --->>" + (getMonster().getDamage() + randomEnemyDamage) + "  " + getPlayer().getName());
                            System.out.println(getMonster().getName() + " attacked the " + getPlayer().getName() + " and hit good damage.");
                            System.out.print(getPlayer().getHealth() + " --> ");
                            getPlayer().setHealth(getPlayer().getHealth() - (getMonster().getDamage() + randomEnemyDamage));
                            System.out.println(getPlayer().getHealth());
                        }
            ...
            if (getPlayer().getInventory().isMineEnter()) {
                ...
                System.out.println("You finished the mine and won various rewards.");
                System.out.println("|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|");
                System.out.println();
            } else {
                System.out.println("You lost. You have to enter the mine again.");
