...
public class River extends BattleLocations {
    ...
    public River(Player player, Bear bear) {
        super(player, bear);
    }
    ...
    public void enterBattleLocation() {
        ...
        if (notReady == 0) {
            ...
            System.out.println("Dont forget, You must defeat all the bears to win the special reward (Water).");
            System.out.println("Also, you have chance to will guns,armors or potions.");
            System.out.println("You will fight a random number of enemies(2-4).");
            ...
            int enemyCount = random.nextInt(2, 5);
            ...
            if (getPlayer().getInventory().isWater()) {
                ...
                System.out.println("The Water has been added to your inventory.");
                System.out.println("|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|*|");
                System.out.println();
            } else {
                System.out.println("You lost. You have to enter the river again.");
